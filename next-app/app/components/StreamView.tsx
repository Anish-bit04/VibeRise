            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-5 w-screen max-w-screen-xl pt-8">
                <div className='col-span-3'>
                    <div className="space-y-4">
                        ...
                        {queue.length === 0 && <Card className="bg-gray-800 border-gray-900 w-full">
                        ...
                        {queue.map((video) => (
                            ...
                            <CardContent className="p-4 flex items-center space-x-4">
                                ...
                                <div className="flex items-center space-x-2 mt-2">
                                    ...
                                    className="flex items-center space-x-1 bg-gray-800 border-gray-900 text-white hover:bg-gray-700"
                                    >
                ...
                <div className='col-span-2'>
                    <div className="max-w-4xl mx-auto p-4 space-y-6 w-full">
                        ...
                        <Button onClick={handleShare} className="bg-indigo-600 text-white hover:bg-indigo-700">
                        ...
                        <Input
                            ...
                            className="bg-gray-800 border-gray-900 text-white placeholder-gray-500"
                        />
                        <Button disabled={loading} onClick={handleSubmit} type="submit" className="w-full bg-indigo-600 text-white hover:bg-indigo-700">{loading ? "Loading..." : "Add to Queue"}</Button>
                        </form>
                        ...
                        {playVideo && <Button disabled={playNextLoader} onClick={playNext} className="w-full bg-indigo-600 text-white hover:bg-indigo-700">
